	...
	if TString(label).Contains("_RS1G_WW_") or TString(label).Contains("_BulkG_WW_") or TString(label).Contains("_Wprime_WZ_"):
	   ...
	   rrv_mass_lvj.setBins(nbins_mlvj)
        ...
        for i in range(treeIn.GetEntries()):
            ...
            self.isGoodEvent = 0;   
            if self.IsGoodEvent(treeIn) and treeIn.issignal and treeIn.MWW> rrv_mass_lvj.getMin() and treeIn.MWW<rrv_mass_lvj.getMax() and tmp_jet_mass>rrv_mass_j.getMin() and tmp_jet_mass<rrv_mass_j.getMax() :
              self.isGoodEvent = 1;   
            ...
            if self.isGoodEvent == 1:
                ...
                tmp_event_weight     = treeIn.weight*tmp_lumi;
                tmp_event_weight4fit = treeIn.hltweight*treeIn.puweight*treeIn.btagweight*treeIn.genweight;
